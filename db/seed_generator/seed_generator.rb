...
def format_assignment(object)

	if object.is_a? Array
		object.each do |obj|
			format_assignment obj
		end
	else
...
format_assignment @process_group_types
...
format_assignment @knowledge_area_types
...
format_assignment @input_and_output_types
...
format_assignment @tool_and_technique_types
