...
ActiveRecord::Schema.define(version: 20171206192713) do
  ...
  create_table "assignments_process_objects", id: false, force: :cascade do |t|
    t.integer "assignment_id",     null: false
    t.integer "process_object_id", null: false
